...
export function streetProps() {
  ...
  return { benches, bins, hydrants, lights, stops };
}
...
export function Props() {
  const { benches, bins, hydrants, lights, stops } = useMemo(streetProps, []);
  ...
  return (
    <group>
      <instancedMesh ref={benchSeat} args={[undefined, undefined, benches.length]} castShadow>
